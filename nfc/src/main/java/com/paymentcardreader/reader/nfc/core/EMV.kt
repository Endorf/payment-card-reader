...
enum class EMV(
    ...
    companion object {
        ...
        fun IIN() = EMV.ISSUER_IDENTIFICATION_NUMBER
        fun AFL() = EMV.APPLICATION_FILE_LOCATOR
        fun ADF() = EMV.APPLICATION_DEDICATED_FILE
        fun PDOL() = EMV.PROCESSING_OPTIONS_DATA_OBJECT_LIST
