...
class EmvTest {
    ...
    fun detect_ApplicationLabel_asString() {
        val mastercardLabel = APPLICATION_LABEL_DEBIT_MASTERCARD
            .extractTLV(EMV.APPLICATION_LABEL)
            .asString()
        assertEquals(MASTERCARD, mastercardLabel)
        val visaLabel = APPLICATION_LABEL_VISA
            .extractTLV(EMV.APPLICATION_LABEL)
            .asString()
        assertEquals(VISA, visaLabel)
        val visa2Label = APPLICATION_LABEL_VISA_CLASSIC
            .extractTLV(EMV.APPLICATION_LABEL)
            .asString()
    ...
    companion object {
        private val APPLICATION_LABEL_DEBIT_MASTERCARD = byteArrayOf(
            80,
            16,
            68,
            101,
        ...
        private val APPLICATION_LABEL_VISA_CLASSIC =
            byteArrayOf(80, 12, 86, 105, 115, 97, 32, 67, 108, 97, 115, 115, 105, 99)
